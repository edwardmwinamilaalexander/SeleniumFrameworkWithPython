...
from utilities.logger import log   # Assuming your logger exposes `log`

@pytest.mark.products
def test_products_page_loads(login_valid_user):
    log.info("Checking if the products page loads correctly")
